...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'Travis19', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '聊聊生活', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://travis19-blog.vercel.app', // 网站地址
